...
int main(){
    ...
    while(exitStatus == 0){
        ...
        if(appChoices.compare("1") == 0){ //if user select guest;
        ...
        else if(appChoices.compare("2") == 0){ //if select member
            ...
            if(loginStatus == true){ //if logged in
                int adminExit = 0;
                while(adminExit != 1){ //3 stands for exit
